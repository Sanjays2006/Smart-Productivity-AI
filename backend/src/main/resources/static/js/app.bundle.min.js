...
let focusTimerState  = 'IDLE';
let pauseCount       = 0;
const RING_CIRC      = 596.9;
...
function selectActivity(id) {
    if (focusTimerState !== 'IDLE') return;
    activeActivityId = id;
...
function updateHistoryMetrics(dash) {
    ...
    if (deepWorkProgress) {
        const progressPct = Math.min(100, Math.round((deepWorkMins / 1440.0) * 100));
